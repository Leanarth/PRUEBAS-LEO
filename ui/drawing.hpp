...
// ── PrettyDrawRectangle ───────────────────────────────────────────────────────
template<typename T>
inline void PrettyDrawRectangle(T obj)              // Esta función se encarga de recibir un objeto y dibujarlo con bordes redondos y borde dorado, además de efectos de hover y presión
{
